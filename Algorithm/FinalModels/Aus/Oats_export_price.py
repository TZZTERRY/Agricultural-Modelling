...
required_X_columns.append('Oats_Production')
required_X_columns.append('America_Oat_production')
required_X_columns.append('America_Oat_export_volume')
required_X_columns.append('America_Oat_trade_value')
required_X_columns.append('Asia_Oat_production')
required_X_columns.append('Asia_Oat_export_volume')
required_X_columns.append('Asia_Oat_trade_value')
required_X_columns.append('Europe_Oat_production')
required_X_columns.append('Europe_Oat_export_volume')
required_X_columns.append('Europe_Oat_trade_value')
required_X_columns.append('Oceania_Oat_production')
required_X_columns.append('Oceania_Oat_export_volume')
required_X_columns.append('Oceania_Oat_trade_value')
required_y_columns.append('Oat_export_price')
...
check_points_path = 'checkpoints_oats_export_price/model.ckpt'
