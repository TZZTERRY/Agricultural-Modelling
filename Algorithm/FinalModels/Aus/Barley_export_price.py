...
required_X_columns.append('Barley_Production')
required_X_columns.append('America_Barley_production')
required_X_columns.append('America_Barley_export_volume')
required_X_columns.append('America_Barley_trade_value')
required_X_columns.append('Asia_Barley_production')
required_X_columns.append('Asia_Barley_export_volume')
required_X_columns.append('Asia_Barley_trade_value')
required_X_columns.append('Europe_Barley_production')
required_X_columns.append('Europe_Barley_export_volume')
required_X_columns.append('Europe_Barley_trade_value')
required_X_columns.append('Oceania_Barley_production')
required_X_columns.append('Oceania_Barley_export_volume')
required_X_columns.append('Oceania_Barley_trade_value')
required_y_columns.append('Barley_export_price')
...
check_points_path = 'checkpoints_barley_export_price/model.ckpt'
