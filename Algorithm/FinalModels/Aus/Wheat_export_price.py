...
required_X_columns.append('Wheat_Production')
required_X_columns.append('America_Wheat_production')
required_X_columns.append('America_Wheat_export_volume')
required_X_columns.append('America_Wheat_trade_value')
required_X_columns.append('Asia_Wheat_production')
required_X_columns.append('Asia_Wheat_export_volume')
required_X_columns.append('Asia_Wheat_trade_value')
required_X_columns.append('Europe_Wheat_production')
required_X_columns.append('Europe_Wheat_export_volume')
required_X_columns.append('Europe_Wheat_trade_value')
required_X_columns.append('Oceania_Wheat_production')
required_X_columns.append('Oceania_Wheat_export_volume')
required_X_columns.append('Oceania_Wheat_trade_value')
required_y_columns.append('Wheat_export_price')
...
check_points_path = 'checkpoints_wheat_export_price/model.ckpt'
