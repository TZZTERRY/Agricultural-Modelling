...
model = tf.keras.models.Sequential([
    ...
    layers.Dense(16, kernel_initializer='random_normal',kernel_regularizer=keras.regularizers.L2(0.001)),
    layers.Activation('relu'),
    layers.Dense(1),
    layers.Activation('relu')
])
...
future_years_dataset.to_csv('prediction_result/Qld_Wheat_Production_prediction.csv', index=None)
print()
