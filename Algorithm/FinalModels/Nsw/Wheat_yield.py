...
model = tf.keras.models.Sequential([
    ...
    layers.Dense(64, kernel_initializer='random_normal',kernel_regularizer=keras.regularizers.L2(0.001)),
    layers.BatchNormalization(),
    layers.Activation('relu'),
    layers.Dense(1),
    layers.Activation('relu')
...
#
# history = model.fit(x=X, y=y.values, batch_size=5, epochs=3000, validation_split=0.01,
