...
raw_data = pd.read_csv('data/NSW_v5.csv', delimiter=',')
areas = ['AUS']
...
required_X_columns.append('Oats_Area')
required_X_columns.append('Covid')
required_y_columns.append('Oats_Production')
...
check_points_path = 'checkpoints_oats_yield/model.ckpt'
